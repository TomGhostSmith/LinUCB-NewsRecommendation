...
class LinUCBHybridExt(MAB):
    def __init__(self, args) -> None:
        ...
        self.userContextDimension = config.userContextDimension * config.articleContextDimension  # assume that we can calculate outer of them
        ...
        self.B = numpy.zeros((config.armCount, config.articleContextDimension, self.userContextDimension))
